...
APP_NAME = env.get("APP_NAME", "webwonking")
...
LOGGING = {
    ...
    "loggers": {
        ...
        "wagtail": {"handlers": [], "level": "INFO", "propagate": False, "formatter": "verbose",},
        "django.request": {
...
if "LOG_DIR" in env:
    # webwonking log
    LOGGING["handlers"]["webwonking_file"] = {
        "level": "INFO",
        "class": "cloghandler.ConcurrentRotatingFileHandler",
        "filename": os.path.join(env["LOG_DIR"], "webwonking.log"),
        "maxBytes": 5242880,  # 5MB
        "backupCount": 5,
    }
    LOGGING["loggers"]["wagtail"]["handlers"].append("webwonking_file")
